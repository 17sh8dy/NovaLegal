...
export const document = {
  id: 'dmca',
  title: 'DMCA Notices',
  description: 'How to send a takedown notice or a counter-notice.',
  category: 'community',
  ...
  status: 'pending',
  note: "Nova does not yet have a DMCA notice process, and no notice address is published. It will be written if a Nova product needs one.",
  effectiveDate: null,
  updatedDate: null,
  version: null,
  sections: [],
